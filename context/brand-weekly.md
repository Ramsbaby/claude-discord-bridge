...
## 🔰 태스크 시작 시 필독 (온보딩)
```
1. Check ~/claude-discord-bridge/rag/teams/shared-inbox/    # 브랜드팀 수신 메시지 확인
2. 지난 주 보고서 확인: ~/claude-discord-bridge/rag/teams/reports/ (brand-*.md)
```

## 타겟 자산
- GitHub: https://github.com/${GITHUB_USERNAME}
- 블로그: ${BLOG_URL}
- 주요 저장소: claude-discord-bridge (공개), ${PRIVATE_REPO_NAME:-my-private-repo} (private)
...
## 분석 항목
1. claude-discord-bridge GitHub 스타/포크 현황 (gh api /repos/${GITHUB_USERNAME}/claude-discord-bridge)
